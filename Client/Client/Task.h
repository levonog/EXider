...
namespace EXider {
	...
	public:
		Task( const PCList& workingPCs, const std::string downloadURL, const std::string executeCommand, bool autoFree = 0 );
		Task( const PCList& workingPCs, const std::string executeCommand, bool autoFree = 0 );
		void run();
